...
#VIRTUAL_ENV=/Users/debruppaul/Documents/Node-js/mcp-course/projects/unit3/build-mcp-server/starter/.venv
...
async def suggest_template(changes_summary: str, change_type: str) -> str:
    ...
    pr_templates = await get_pr_templates()
    templates = json.loads(pr_templates)
    temp_file=TYPE_MAPPING.get(change_type.lower(), "feature.md")
    for t in templates:
        if temp_file in t.get("filename"):
            selected_template = t
            
    suggestion = {
        "recommended_template": selected_template["filename"],
